namespace DuplicateFinderMulti
{
    partial class DuplicateFinderMultiRibbon : Microsoft.Office.Tools.Ribbon.RibbonBase
    {
      ...
      // 
      this.tabDuplicateFinderMulti.Groups.Add(this.grpPane);
      this.tabDuplicateFinderMulti.Groups.Add(this.grpUser);
      this.tabDuplicateFinderMulti.Groups.Add(this.grpProject);
      this.tabDuplicateFinderMulti.Groups.Add(this.grpSourceDocs);
      this.tabDuplicateFinderMulti.Groups.Add(this.grpAnalysis);
      this.tabDuplicateFinderMulti.Groups.Add(this.grpAbout);
